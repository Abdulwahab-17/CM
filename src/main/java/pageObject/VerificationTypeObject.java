...
public class VerificationTypeObject {

	WebDriver driver;
   
	public VerificationTypeObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Verification Type") WebElement VerificationType;
	public void ClickVerificationType() {
		VerificationType.click();
	}
