...
public class PaymentTypeObject {
	...
	public PaymentTypeObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Payment Type") WebElement PaymentType;
	public void ClickPaymentType() {
		PaymentType.click();
	}
	
	@FindBy(how = How.XPATH, using = "//div[@class='d-block']//a[1]") WebElement NewPaymentTypeAdd;
	public void ClickAddNewPaymentType() {
		NewPaymentTypeAdd.click();
	}
