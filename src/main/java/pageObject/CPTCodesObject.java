...
public class CPTCodesObject {

	WebDriver driver;

	public CPTCodesObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "CPT Codes") WebElement CPTCode;
	public void ClickCPTCode() {
		CPTCode.click();
	}

	@FindBy(how = How.XPATH, using = "(//a[@data-toggle='modal'])[1]") WebElement NewCPTAdd;
	public void ClickAddNewCPT() {
		NewCPTAdd.click();
	}
