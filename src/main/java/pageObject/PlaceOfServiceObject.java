...
public class PlaceOfServiceObject {

	WebDriver driver;

	public PlaceOfServiceObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Place of Service") WebElement PlaceOfService;
	public void ClickPlaceOfService() {
		PlaceOfService.click();
	}

	@FindBy(how = How.XPATH, using = "//div[@class='d-block']//a[1]") WebElement NewPlaceOfServiceAdd;
	public void ClickAddNewPlaceOfService() {
		NewPlaceOfServiceAdd.click();
	}

	@FindBy(how = How.XPATH, using = "(//input[@formcontrolname='code'])[2]") WebElement CodeAdd;
	...
	///////////////////////////////////////////Filter///////////////////////////////////////////////////////////////
	@FindBy(how = How.XPATH, using = "//input[@formcontrolname='code']") WebElement CodeFilter;
