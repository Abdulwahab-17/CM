...
public class CodeTypeObject {
	...
	public CodeTypeObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Code Type") WebElement CodeType;
	public void ClickCodeType() {
		CodeType.click();
	}
	
	@FindBy(how = How.XPATH, using = "(//a[@data-toggle='modal'])[1]") WebElement NewCodeTypeAdd;
	public void ClickAddNewCodeType() {
		NewCodeTypeAdd.click();
	}
	...
	@FindBy(how = How.XPATH, using = "//input[@formcontrolname='slug']") WebElement SlugAdd;
	public void AddSlug(String name) {
		SlugAdd.sendKeys(name);
	}
	...
	@FindBy(how = How.XPATH, using = "//input[@formcontrolname='slug']") WebElement SlugEdit;
	public void ClearSlug() {
		SlugEdit.clear();
	}
	public void EditSlug(String name) {
		SlugEdit.sendKeys(name);
	}
