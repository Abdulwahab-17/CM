...
public class HCPCSObject {

	WebDriver driver;

	public HCPCSObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "HCPCS") WebElement HCPCS;
	public void ClickHCPCS() {
		HCPCS.click();
	}

	@FindBy(how = How.XPATH, using = "(//a[@data-toggle='modal'])[1]") WebElement NewHCPCSAdd;
	public void ClickAddNewHCPCS() {
		NewHCPCSAdd.click();
	}
