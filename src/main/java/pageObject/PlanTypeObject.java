...
public class PlanTypeObject {
	
	WebDriver driver;

	public PlanTypeObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Plan Type") WebElement  PlanType;
	public void ClickPlanType() {
		PlanType.click();
	}
	
	
	@FindBy(how=How.XPATH, using = "(//button[@type='button'])[2]") WebElement AddNew;
	public void ClickAddNew() {
		AddNew.click();
	}
	
	@FindBy(how=How.XPATH, using = "(//input[@formcontrolname='plan_type'])[2]") WebElement Name;
	...
	////////////////////////////////Filter/////////////////////////////////////////////
	@FindBy(how = How.XPATH, using = "//input[@formcontrolname='plan_type']") WebElement NameFilter;
