...
public class CaseStatusObject {

	WebDriver driver;

	public CaseStatusObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Case Status") WebElement Casestatus;
	public void ClickCaseStatus() {
		Casestatus.click();
	}

	@FindBy(how = How.XPATH, using = "//div[@class='d-block']//a[1]") WebElement NewCaseStatusAdd;
	public void ClickAddNewCaseStatus() {
		NewCaseStatusAdd.click();
	}
	...
	@FindBy(how = How.XPATH, using = "//button[@class='btn btn-success']") WebElement Save;
	...
	@FindBy(how=How.XPATH, using = "//button[text()='Update']") WebElement Submit;
