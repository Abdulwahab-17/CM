...
public class PaidByObject {
	
	WebDriver driver;

	public PaidByObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Paid By") WebElement PaidBy;
	public void ClickPaidBy() {
		PaidBy.click();
	}

	@FindBy(how = How.XPATH, using = "//div[@class='d-block']//a[1]") WebElement NewPaidByAdd;
	public void ClickAddNewPaidBy() {
		NewPaidByAdd.click();
	}
