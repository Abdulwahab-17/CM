...
public class BillingTitleObject {
	
	WebDriver driver;

	public BillingTitleObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Billing Title") WebElement BillingTitle;
	public void ClickBillingTitle() {
		BillingTitle.click();
	}

	@FindBy(how = How.XPATH, using = "//div[@class='d-block']//a[1]") WebElement NewBillingTitleADD;
	public void ClickAddNewBillingTitle() {
		NewBillingTitleADD.click();
	}
