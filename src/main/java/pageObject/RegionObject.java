...
public class RegionObject {
	...
	public RegionObject(WebDriver driver) {
	...
	@FindBy(how = How.LINK_TEXT, using = "Region") WebElement Region;
	public void ClickRegion() {
		Region.click();
	}

	@FindBy(how = How.XPATH, using = "//div[@class='d-block']//a[1]") WebElement NewRegionAdd;
