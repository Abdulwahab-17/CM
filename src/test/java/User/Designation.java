...
public class Designation extends base {
	///Now we can not update Designation name so we will have to add new Designation name every time
	@Test(priority = 1)	
	public void AddDesignation() throws Exception {	
		Thread.sleep(8000);	
	...
	@Test(priority = 2)	
	public void FilterDesignation() throws Exception {		
		Thread.sleep(8000);	
		driver.findElement(By.xpath("//a[contains(text(),'Master')]")).click();	
		Thread.sleep(3000);
	...
	@Test(priority = 3)	public void EditDesignation() throws Exception {	
