...
public class Insurance extends base {
	...
	public void AddInsurance() throws Exception {
		...
		driver.findElement(By.xpath("(//input[@formcontrolname='insurance_name'])[2]")).sendKeys(Name);
	...
	public void FilterInsurance() throws Exception {
		Thread.sleep(5000);
		///Change the insurance name here which you added
		driver.findElement(By.id("insurance_name")).sendKeys(Name);
	...
	public void EditInsurance() throws Exception {
		...
		driver.findElement(By.xpath("(//input[@id='insurance_name'])[2]")).sendKeys(data.currency().code());
		driver.findElement(By.id("insurance_code")).clear();
	    ...
	    System.out.println("here is"+Result);
	    Assert.assertEquals(Result, "Insurance Updated!");
